...
static int minix_getdents(struct m_inode *inode, struct file *filp, struct dirent *dirent, int count)
{
...
static int minix_getdents64(struct m_inode *inode, struct file *filp, struct dirent64 *dirent, int count)
{
        unsigned int offset, i;
        char c;
        struct buffer_head *bh;
